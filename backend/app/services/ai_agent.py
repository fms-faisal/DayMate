...
def generate_day_plan(weather_data: dict, news_data: list, city: str = None) -> dict:
    """
...
Create a warm, personalized daily plan. Be like a helpful friend who lives in {location_name}.
